...
This application demonstrates a simple GenAI Diff Performance Review using Cloud Run.
...
```bash
gcloud artifacts repositories create perf-review-repo \
       --repository-format=docker \
       --location=$MY_LOCATION \
       --description="PerfReview Docker Repository"
``` 
